...
{
	// this has been copied from ~/fwrepo/flexbridge/src/FLEx-ChorusPlugin/Infrastructure/FlexbridgeSychronizerAdjunct.cs
	// TODO: refactor FlexbridgeSychronizerAdjunct.cs so it can be used here. IJH 2016-03
	internal sealed class LfMergeSychronizerAdjunct : ISychronizerAdjunct
	{
		...
		internal LfMergeSychronizerAdjunct(string fwdataPathname, string fixitPathname, bool writeVerbose)
		{
