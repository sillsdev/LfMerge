...
RUN apt-get update && apt-get install -y sudo debhelper devscripts cli-common-dev iputils-ping wget cpp libgit2-dev mercurial python-dev php-dev php-pear pkg-config mono5-sil mono5-sil-msbuild libicu-dev lfmerge-fdo
